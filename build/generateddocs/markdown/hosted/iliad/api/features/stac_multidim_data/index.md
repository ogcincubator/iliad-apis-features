...
<http://w3id.org/ogcincubator/simulation> a geojson:Feature ;
    ...
    rdfs:seeAlso [ rdfs:label "optional link to the web service (not raw file) like OGC Web Map Service (WMS) either one enclosure or service is required in Iliad profile" ;
    ...
    ns3:assets <http://w3id.org/ogcincubator/data> ;

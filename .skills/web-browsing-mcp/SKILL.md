...
This skill enables web browsing capabilities using MCP (Model Context Protocol) servers to execute API commands for data discovery and retrieval.
...
This skill is particularly useful for the marine data agent for discovering and validating authoritative vocabularies and data services.
